...
SECRET_KEY = 'django-insecure-28fni*1l*79(gs$v33eh$*_w+7!&vde96zac!gm$^jdd@4+o)a'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "core.util.admin_context.admin_context",
            ],
        },
    },
]
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'samsudeveloper@gmail.com'
EMAIL_HOST_PASSWORD = 'vhrh glct sffq mmck'
